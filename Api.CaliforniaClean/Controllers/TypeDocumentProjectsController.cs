...
namespace Api.CaliforniaClean.Controllers
{
    ...
    public class TypeDocumentProjectsController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TypeDocumentProject>>> GetTypeDocumentProjects ( [FromQuery] PaginationParams pagination )
        {
            try
            {
                var query = _context.TypeDocumentProjects.AsQueryable ( );
